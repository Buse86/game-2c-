...
class GameRenderer:
    ...
    def draw_game(self, screen, manager, btn_to_menu, width, height):
        ...
        self._draw_grid(screen, manager)
        self._draw_path(screen, manager)
        self._draw_base_hp(screen, manager)
        self._draw_towers(screen, manager)
        self._draw_enemies(screen, manager)
        self._draw_projectiles(screen, manager)
        self._draw_hud(screen, manager, btn_to_menu, width, height)
        self._draw_upgrade_text(screen, manager, width)
        if manager.game_over:
            self._draw_game_over(screen, width, height)
